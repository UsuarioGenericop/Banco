...
public class Main {
    ...
    public static void main(String[] args) {
        Cliente cliente = new Cliente("X", 123456);
        ...
        String respuestaRetirar = scanner.nextLine();
        while (!respuestaRetirar.equalsIgnoreCase("y")) {
            System.out.print("Deseas retirar? (y/n): ");
            respuestaRetirar = scanner.nextLine();
        }
        ...
        while (PIN != cliente.PIN) {
            ...
            System.out.print("Ingresa tu PIN: ");//PIN correcto 654321
            PIN = scanner.nextInt();
        }
        ...
        if (retiro > cliente.fondos) {
            ...
            cliente.fondos -= retiro;
            System.out.print("\u001B[31mFondos: \u001B[0m" + cliente.fondos);
        }


        Empleado empleado1 = new Empleado("Y", 123, 9, "cajero");
        empleado1.calcularVacaciones();
        empleado1.mostrarVacaciones();

        Ahorros cuenta1 = new Ahorros(22, "Z", 10.0);
        cuenta1.detallesCuenta();
        cuenta1.mostrarTodo();
        cuenta1.depositar(20.0);
